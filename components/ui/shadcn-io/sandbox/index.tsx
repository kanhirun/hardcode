...
export const SandboxProvider = ({
  ...
  <div className={cn('size-full', className)}>
    <SandpackProvider className="!size-full !max-h-none" {...(props as any)} />
  </div>
);
...
export const SandboxCodeEditor = ({
  ...
  <SandpackCodeEditor showTabs={showTabs} {...(props as any)} />
);
...
export const SandboxConsole = ({
  ...
  <SandpackConsole className={cn('h-full', className)} {...(props as any)} />
);
